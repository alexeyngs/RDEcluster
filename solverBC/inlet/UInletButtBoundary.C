...
extern "C"
{
    ...
    void UInletButtBoundary_1_0(bool load)
    {
        if (load)
        {
...
makeRemovablePatchTypeField(fvPatchVectorField,UInletButtBoundary);
const char* const UInletButtBoundary::SHA1sum = "2cb7a0c4345a61b88d329a26e832e625c53cdd92";

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
UInletButtBoundary::UInletButtBoundary(const fvPatch& p,const DimensionedField<vector, volMesh>& iF):fixedValueFvPatchField<vector>(p, iF)
{
    if (false)
    {
...
UInletButtBoundary::UInletButtBoundary(const UInletButtBoundary& ptf,const fvPatch& p,const DimensionedField<vector, volMesh>& iF,const fvPatchFieldMapper& mapper):fixedValueFvPatchField<vector>(ptf, p, iF, mapper)
{
    if (false)
    {
...
UInletButtBoundary::UInletButtBoundary(const fvPatch& p,const DimensionedField<vector, volMesh>& iF, const dictionary& dict):fixedValueFvPatchField<vector>(p, iF, dict)
{
    if (false)
    {
...
UInletButtBoundary::UInletButtBoundary(const UInletButtBoundary& ptf):fixedValueFvPatchField<vector>(ptf)
{
    if (false)
    {
        Info<<"construct ramU sha1: 2cb7a0c4345a61b88d329a26e832e625c53cdd92"
...
UInletButtBoundary::UInletButtBoundary(const UInletButtBoundary& ptf,const DimensionedField<vector, volMesh>& iF):fixedValueFvPatchField<vector>(ptf, iF)
{
    if (false)
    {
        Info<<"construct ramU sha1: 2cb7a0c4345a61b88d329a26e832e625c53cdd92 "
...
// * * * * * * * * * * * * * * * * Destructor  * * * * * * * * * * * * * * * //
UInletButtBoundary::~UInletButtBoundary()
{
    if (false)
    {
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void UInletButtBoundary::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
//begin code
    ...
    forAll(Cf, facei)
    {
        ...
        result[facei] = ::UinButt(scalarParameters, time, Normals.ref()[facei], MolWeightStar, MolWeight, p.ref()[facei], T.ref()[facei], rho.ref()[facei], U.ref()[facei], c.ref()[facei], gamma.ref()[facei]);
    }
