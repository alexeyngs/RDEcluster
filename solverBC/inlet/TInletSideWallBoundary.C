#include "TInletSideWallBoundary.H"
...
extern "C"
{
    ...
    void TInletSideWallBoundary_1_0(bool load)
    {
        if (load)
        {
...
const char * const TInletSideWallBoundary::SHA1sum = "66d4e0b38a18f2b7674332f6d021721a92f0e80e";

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
TInletSideWallBoundary::TInletSideWallBoundary(const fvPatch& p,const DimensionedField<scalar, volMesh>& iF):fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct TInletSideWallBoundary sha1: 66d4e0b38a18f2b7674332f6d021721a92f0e80e from patch/DimensionedField\n";
    }
}

TInletSideWallBoundary::TInletSideWallBoundary(const TInletSideWallBoundary& ptf,const fvPatch& p,const DimensionedField<scalar, volMesh>& iF,const fvPatchFieldMapper& mapper):fixedValueFvPatchField<scalar>(ptf, p, iF, mapper)
{
    if (false)
    {
        Info<<"construct TInletSideWallBoundary from patch/DimensionedField/mapper" << endl;
    }
}

TInletSideWallBoundary::TInletSideWallBoundary(const fvPatch& p,const DimensionedField<scalar, volMesh>& iF,const dictionary& dict):fixedValueFvPatchField<scalar>(p, iF, dict)
{
    if (false)
    {
        Info<<"construct TInletSideWallBoundary from patch/dictionary" << endl;
    }
}

TInletSideWallBoundary::TInletSideWallBoundary(const TInletSideWallBoundary& ptf):fixedValueFvPatchField<scalar>(ptf)
{
    if (false)
    {
        Info<<"construct TInletSideWallBoundary as copy" << endl;;
    }
}

TInletSideWallBoundary::TInletSideWallBoundary(const TInletSideWallBoundary& ptf, const DimensionedField<scalar, volMesh>& iF):fixedValueFvPatchField<scalar>(ptf, iF)
{
    if (false)
    {
        Info<<"construct TInletSideWallBoundary as copy/DimensionedField\n";
    }
}
// * * * * * * * * * * * * * * * * Destructor  * * * * * * * * * * * * * * * //
TInletSideWallBoundary::~TInletSideWallBoundary()
{
    if (false)
    {
        Info << "destroy TInletSideWallBoundary" << endl;
    }
}
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void TInletSideWallBoundary::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    if (false)
    {
        Info << "updateCoeffs TInletSideWallBoundary" << endl;
    }
// begin code
    ...
    forAll(Cf, facei)
    {
        const Foam::scalar MolWeight = Thermo.patchInletSideWallMolWeight(ThisPatch, facei);
        Foam::scalar MolWeightStar = Thermo.MolWeightStar();
        result[facei] = ::TinSideWall(scalarParameters, time, MolWeightStar, MolWeight, p.ref()[facei], T.ref()[facei], rho.ref()[facei], U.ref()[facei], c.ref()[facei], gamma.ref()[facei]);
    }
//this->operator==(300.0);
// end code
